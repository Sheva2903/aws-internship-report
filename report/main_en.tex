...
\\
\\
\textbf{\Large SEMESTER 263 -- ACADEMIC YEAR 2025--2026} \\
\end{tabular}
\end{center}
\vspace{0.5cm}
\begin{itemize}
...
\renewcommand\labelitemi{--}
    ...
    \\ \Large \textbf{Amazon Web Services Vietnam}
    ...
    \\ \Large \textbf{Nguyễn Phương	Duy}
    \item \Large \textbf{STUDENT:}
    \\ \Large \textbf{FULL NAME: Đỗ Hữu Di} \textbf{STUDENT ID: 2352162}
\end{itemize}
\vspace{0.5cm}
\begin{center}
